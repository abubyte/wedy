...
FeaturedServiceDto _$FeaturedServiceDtoFromJson(Map<String, dynamic> json) => FeaturedServiceDto(
...
Map<String, dynamic> _$FeaturedServiceDtoToJson(FeaturedServiceDto instance) => <String, dynamic>{
  'id': instance.id,
...
MerchantFeaturedServicesDto _$MerchantFeaturedServicesDtoFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$MerchantFeaturedServicesDtoToJson(MerchantFeaturedServicesDto instance) => <String, dynamic>{
