...
CompleteRegistrationRequestDto _$CompleteRegistrationRequestDtoFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$CompleteRegistrationRequestDtoToJson(
        CompleteRegistrationRequestDto instance) =>
    <String, dynamic>{
      'phone_number': instance.phoneNumber,
      'name': instance.name,
