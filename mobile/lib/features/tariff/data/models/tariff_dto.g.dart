...
TariffPlanDto _$TariffPlanDtoFromJson(Map<String, dynamic> json) => TariffPlanDto(
...
Map<String, dynamic> _$TariffPlanDtoToJson(TariffPlanDto instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
...
SubscriptionDto _$SubscriptionDtoFromJson(Map<String, dynamic> json) => SubscriptionDto(
  id: json['id'] as String,
  tariffPlan: TariffPlanDto.fromJson(json['tariff_plan'] as Map<String, dynamic>),
...
SubscriptionWithLimitsResponseDto _$SubscriptionWithLimitsResponseDtoFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$SubscriptionWithLimitsResponseDtoToJson(SubscriptionWithLimitsResponseDto instance) =>
    <String, dynamic>{'subscription': instance.subscription, 'limits': instance.limits, 'message': instance.message};

PaymentResponseDto _$PaymentResponseDtoFromJson(Map<String, dynamic> json) => PaymentResponseDto(
  id: json['id'] as String,
...
Map<String, dynamic> _$PaymentResponseDtoToJson(PaymentResponseDto instance) => <String, dynamic>{
  'id': instance.id,
