...
class _ServiceRemoteDataSource implements ServiceRemoteDataSource {
  ...
  Future<PaginatedServiceResponseDto> getServices({
    ...
    final queryParameters = <String, dynamic>{
      ...
      r'location_region': locationRegion,
      r'min_price': minPrice,
      r'max_price': maxPrice,
      r'min_rating': minRating,
      r'is_verified_merchant': isVerifiedMerchant,
      r'sort_by': sortBy,
    ...
    try {
      _value = PaginatedServiceResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<ServiceDetailDto> getServiceById(String serviceId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<ServiceInteractionResponseDto> interactWithService(String serviceId, Map<String, dynamic> body) async {
    ...
    try {
      _value = ServiceInteractionResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<UserInteractionsResponseDto> getUserInteractions() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    ...
    try {
      _value = UserInteractionsResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<MerchantServicesResponseDto> getMerchantServices() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    ...
    try {
      _value = MerchantServicesResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
