...
UserInteractionItemDto _$UserInteractionItemDtoFromJson(
        Map<String, dynamic> json) =>
    UserInteractionItemDto(
      interactionType: json['interaction_type'] as String,
      interactedAt: json['interacted_at'] as String,
      service:
          ServiceListItemDto.fromJson(json['service'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$UserInteractionItemDtoToJson(
        UserInteractionItemDto instance) =>
    <String, dynamic>{
...
UserInteractionsResponseDto _$UserInteractionsResponseDtoFromJson(
        Map<String, dynamic> json) =>
    UserInteractionsResponseDto(
      likedServices: (json['liked_services'] as List<dynamic>)
          .map(
              (e) => UserInteractionItemDto.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$UserInteractionsResponseDtoToJson(
        UserInteractionsResponseDto instance) =>
    <String, dynamic>{
